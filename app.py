...
# to write my final path for the decoder
decoder.load_state_dict(torch.load(r'C:\Users\risha\Desktop\NST\experiment\experiment1\decoder_epoch_10.pth', map_location=device))
